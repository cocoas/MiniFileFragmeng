 ...
 */
public class APKFileTestActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder b = new AlertDialog.Builder(APKFileTestActivity.this);
                ...
                b.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mData = getData();
                        mAdapter = new FileListAdapter(mData, APKFileTestActivity.this);
                        mListView.setAdapter(mAdapter);
                    }
                });
    ...
    public List<Map<String, Object>> getData() {
        ...
        if (files != null) {
            for (File file : files) {
                if (checkIsAPKFiles(file.getPath())) {
                    map = new HashMap<String, Object>();
