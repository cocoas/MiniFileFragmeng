 ...
 * 扫描某一文件夹下面所有文档的Activity
 */
public class WordFileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SimpleUtils.openFile(WordFileActivity.this, file);
            }
        });
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder b = new AlertDialog.Builder(WordFileActivity.this);
                ...
                b.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mData = getData();
                        mAdapter = new FileListAdapter(mData, WordFileActivity.this);
                        mListView.setAdapter(mAdapter);
                    }
                });
    ...
    public List<Map<String, Object>> getData() {
        ...
        if (files != null) {
            for (File file : files) {
                if (checkIsWordFiles(file.getPath())) {
                    map = new HashMap<String, Object>();
                    map.put("title", file.getName());
                    map.put("info", file.getPath());
                    map.put("img", R.drawable.type_document);
                    list.add(map);
                }
    ...
    private boolean checkIsWordFiles(String fName) {
